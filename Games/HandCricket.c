/* hand_cricket_compact.c
   Compact single-file Hand Cricket (PvC, PvP, Team modes)
   Features:
     - PvC, PvP offline, Team vs Team, Team vs Computer
     - Toss (odd/even)
     - Number mode (0-6 or 1-6)
     - Overs (0 = unlimited)
     - Clear screen after each player's input (Method 1)
     - AI Easy (random) and Medium (biased)
   Compile: gcc hand_cricket_compact.c -o hand_cricket
*/
